            ...
            options: [
              {
                ...
                value: false,
                tooltip: `{{t("Update all eligible data at one time, which has better performance when the amount of data is large. But the updated data will not trigger other workflows, will not record audit logs, and may not update association fields.", { ns: "${NAMESPACE}" })}}`,
              },
              {
