    ...
    const systemStatuses = [
      {
        ...
        description: 'Normal active user',
        sort: 1,
        config: {},
      },
      {
        ...
        color: 'orange',
        allowLogin: false,
        loginErrorMessage: 'Your account is under review, please wait for administrator approval',
        systemDefined: true,
        packageName: '@tachybase/module-user',
        description: 'User waiting for approval',
        sort: 2,
        config: {},
      },
      {
        ...
        color: 'gray',
        allowLogin: false,
        loginErrorMessage: 'Your account has been disabled, please contact administrator if you have any questions',
        systemDefined: true,
        packageName: '@tachybase/module-user',
        description: 'Manually disabled by administrator',
        sort: 3,
        config: {},
      },
    ];
