...
- **workflow**: add detailed tenant failure diagnostics (@TomyJan)
...
- **workflow**: preserve tenant-aware event outcomes (@TomyJan)

## [1.6.45] - 2026-08-24

### 🐛 Fixed

- **workflow**: enforce legacy tenant data rules (@TomyJan)
...
- **tenant**: handle associations sharing a foreign key ([#410](https://github.com/tegojs/tego-standard/pull/410)) (@TomyJan)
- **tenant**: clarify data isolation labels ([#409](https://github.com/tegojs/tego-standard/pull/409)) (@TomyJan)

## [1.6.38] - 2026-08-20

### 🐛 Fixed

- **tenant**: distinguish association relinks from value updates (@TomyJan)
...
- approval quick add ([#403](https://github.com/tegojs/tego-standard/pull/403)) (@dududuna)

### 🐛 Fixed

- **department**: resolve roles for external data sources ([#405](https://github.com/tegojs/tego-standard/pull/405)) (@TomyJan)
- **workflow-approval**: ensure copied approval data and transaction consistency ([#404](https://github.com/tegojs/tego-standard/pull/404)) (@TomyJan)
...
[Unreleased]: https://github.com/tegojs/tego-standard/compare/v1.6.58...HEAD
