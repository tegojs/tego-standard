...
export const radioComponentFieldEditableSettings = new EditableSchemaSettings({
  name: 'editableFieldSettings:component:Radio group',
  items: [
    {
      name: 'fieldComponent',
      useSchema() {
        ...
        return {
          ...
          default: fieldSchema['x-component-props']?.mode || 'Radio group',
