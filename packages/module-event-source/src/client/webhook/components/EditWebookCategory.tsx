...
const useEditCategry = () => {
  ...
  return {
    async run() {
      ...
      await api.resource('webhookCategories').update({
        filter: { id: id },
        values: {
          ...values,
        },
...
export const EditWebhookCategory = (props) => {
  return <EditWebhookCategoryAction {...props} />;
};

export const EditWebhookCategoryAction = (props) => {
