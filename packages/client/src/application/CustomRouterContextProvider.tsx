...
export const IsSubPageClosedByPageMenuProvider: FC<{ children: React.ReactNode }> = ({ children }) => {
 ...
 */
const RouterBasenameProvider: FC<{ children: React.ReactNode }> = ({ children }) => {
...
const SearchParamsProvider: FC<{ children: React.ReactNode }> = ({ children }) => {
...
const MatchAdminNameProvider: FC<{ children: React.ReactNode }> = ({ children }) => {
...
const IsAdminPageProvider: FC<{ children: React.ReactNode }> = ({ children }) => {
  const location = useLocation();
  const isAdminPage = location.pathname.startsWith('/admin');
  return <IsAdminPageContext.Provider value={isAdminPage}>{children}</IsAdminPageContext.Provider>;
};

export const CurrentPageUidProvider: FC<{ children: React.ReactNode }> = ({ children }) => {
  const params = useParams();
  return <CurrentPageUidContext.Provider value={params.name}>{children}</CurrentPageUidContext.Provider>;
};

export const CurrentTabUidProvider: FC<{ children: React.ReactNode }> = ({ children }) => {
  const params = useParams();
 ...
 * @returns
 */
const NavigateNoUpdateProvider: FC<{ children: React.ReactNode }> = ({ children }) => {
 ...
 **/
const LocationNoUpdateProvider: FC<{ children: React.ReactNode }> = ({ children }) => {
  const location = useLocation();
...
const LocationSearchProvider: FC<{ children: React.ReactNode }> = ({ children }) => {
  const location = useLocation();
...
export const CustomRouterContextProvider: FC<{ children: React.ReactNode }> = ({ children }) => {
  return (
